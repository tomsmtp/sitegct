...
export default function LogisticaPage({ currentUser }) {
    ...
    const handleRegistrar = () => {
        if (!formData.disponibilidade || !formData.cpf || !formData.nome || !formData.empresa || !formData.placa || !formData.capacidade || !formData.destino || !formData.combustivel || !formData.tipoFrete || !formData.frete) {
    ...
    const handleSalvarEdicao = () => {
        if (!formEdicao.disponibilidade || !formEdicao.cpf || !formEdicao.nome || !formEdicao.empresa || !formEdicao.placa || !formEdicao.capacidade || !formEdicao.destino || !formEdicao.combustivel || !formEdicao.tipoFrete || !formEdicao.frete) {
            alert("Preencha todos os campos!");
            return;
        }
    ...
    return (
        <div className="case-logistic">
            ...
            <label>
                ...
                onKeyDown={e => {if (e.key === "Enter") {tipoFreteRef.current.focus();}}}
                />
            </label>
            ...
            <label>
                ...
                >
                    ...
                    <option value="TONELADA">TONELADA (GRÃOS)</option>
                    <option value="CAIXA">CAIXA (CITRUS)</option>
                ...
                <div className="registros-lista">
                    ...
                    {registros.map((registro) => (
                        <div key={registro.id} className="registro-card">
                            ...
                            <span>TIPO DE FRETE: {registro.tipoFrete}</span>
            ...
            <div className="modal-overlay" onClick={handleCancelarEdicao}>
                <div className="modal-content" onClick={e => e.stopPropagation()}>
                    ...
                    <label>
                        TIPO DE FRETE:
                        <select
                            value={formEdicao.tipoFrete}
                            onChange={e => setFormEdicao({...formEdicao, tipoFrete: e.target.value})}
                        >
                            <option value="">Selecione</option>
                            <option value="TONELADA">TONELADA (GRÃOS)</option>
                            <option value="CAIXA">CAIXA (CITRUS)</option>
