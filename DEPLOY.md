...
4. Preencha:
   - **Project name:** `gestao-graos` (ou outro nome)
   - **Visibility:** Private ou Public
5. Clique em **"Create project"**

### 1.2 Fazer push do código

No terminal da pasta `gestao_graos/`:
...
git branch -M main
git remote add origin https://gitlab.com/seu-usuario/gestao-graos.git
...
1. Escolha o repositório `gestao-graos`
...
O JavaScript do site chamará a API automaticamente:
